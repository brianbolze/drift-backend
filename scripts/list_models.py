...
def get_openai_models():
    ...
    try:
        ...
        other_models = [m for m in sorted(gpt_models)
                       if m not in priority_models and ('gpt-5' in m or 'gpt-4.1' in m)]
    ...
    try:
        ...
        if hasattr(client, 'models') and hasattr(client.models, 'list'):
            try:
                ...
                other_models = [m for m in model_ids
                              if m not in priority_order and 'claude' in m and '4' in m]
