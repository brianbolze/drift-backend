...
CALIBER_PLATFORMS = [
    ...
    {
        "caliber_name": "6.5 PRC",
        "platform": "ar10",
        "rank": 7,
        "notes": "Requires dedicated large-bolt AR-10 upper (e.g. POF Revolution).",
    },
]
...
ENTITY_ALIASES: list[dict] = [
    ...
    {
        "entity_type": "manufacturer",
        "entity_name": "Cutting Edge Bullets",
        "alias": "CEB",
        "alias_type": "abbreviation",
    },
    ...
    {
        "entity_type": "manufacturer",
        "entity_name": "Accuracy International",
        "alias": "AI",
        "alias_type": "abbreviation",
    },
    {
        "entity_type": "manufacturer",
        "entity_name": "Christensen Arms",
        "alias": "Christensen",
        "alias_type": "abbreviation",
    },
    {
    ...
    {
        "entity_type": "manufacturer",
        "entity_name": "MDT (Modular Driven Technologies)",
        "alias": "MDT",
        "alias_type": "abbreviation",
    },
    {
        "entity_type": "manufacturer",
        "entity_name": "KRG (Kinetic Research Group)",
        "alias": "KRG",
        "alias_type": "abbreviation",
    },
    {
        "entity_type": "manufacturer",
        "entity_name": "Foundation Stocks",
        "alias": "Foundation",
        "alias_type": "abbreviation",
    },
    ...
    {
        "entity_type": "manufacturer",
        "entity_name": "Manners Composite Stocks",
        "alias": "Manners",
        "alias_type": "abbreviation",
    },
    ...
    {
        "entity_type": "manufacturer",
        "entity_name": "Schmidt & Bender",
        "alias": "S&B Optics",
        "alias_type": "abbreviation",
    },
    {
        "entity_type": "manufacturer",
        "entity_name": "Bartlein Barrels",
        "alias": "Bartlein",
        "alias_type": "abbreviation",
    },
    {
    ...
    {
        "entity_type": "manufacturer",
        "entity_name": "Criterion Barrels",
        "alias": "Criterion",
        "alias_type": "abbreviation",
    },
    {
        "entity_type": "manufacturer",
        "entity_name": "TriggerTech",
        "alias": "Trigger Tech",
    ...
    {
        "entity_type": "manufacturer",
        "entity_name": "Kestrel Ballistics",
        "alias": "Kestrel",
        "alias_type": "abbreviation",
    },
