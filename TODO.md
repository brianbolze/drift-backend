...
- [x] ~~**Lock the 3 remaining v6 resolver tech-debt carts** (cases 6/10/23).~~ Shipped 2026-04-23 in patch 038. Carts `86685620`, `a65f25b2`, `0761bf5c` now `is_locked=true`; pipeline-store-commit will skip them. Deeper resolver fixes (variant-suffix disambiguation, within-brand caliber marker scoring, ambiguity gate) remain open below.
