...
- [ ] Delete the "338 Lapua Magnum 300gr Lapua Scenar" Berger bullet (id=f18fef38) — it's a cartridge-named row, not a bullet. Ingesting the Berger Lapua Scenar factory cartridge resolves to this data-pollution bullet rather than the real Lapua "19,4 g / 300 gr Scenar OTM GB528". Curation patch. (source: v6 resolver regression case 26, 2026-04-22)
