...
- [x] Berger 30cal 245gr Elite Hunter wrong source_url (points to 338-cal page) and missing BCs (G1=0.807, G7=0.413) — fixed via curation patch 002 (source: QA report, 2026-03-06)
